package edu.uiowa.AcknowledgementsTagLib;
...
public class AcknowledgementsTagLibBodyTagSupport extends BodyTagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;

    public AcknowledgementsTagLibBodyTagSupport() {
        super();
    }

    private static final Log log = LogFactory.getLog(AcknowledgementsTagLibBodyTagSupport.class);
    ...
    public DataSource getDataSource() {
        if (theDataSource == null) try {
            theDataSource = (DataSource)new InitialContext().lookup("java:/comp/env/jdbc/AcknowledgementsTagLib");
        } catch (Exception e) {
