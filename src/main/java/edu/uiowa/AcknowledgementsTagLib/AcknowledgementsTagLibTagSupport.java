...
public class AcknowledgementsTagLibTagSupport extends TagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;
    private static final Log log = LogFactory.getLog(AcknowledgementsTagLibTagSupport.class);

    public AcknowledgementsTagLibTagSupport() {
        super();
    }
